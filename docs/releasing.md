...
```sh
git tag -a v0.2.0 -m "Foundry MCP Bridge v0.2.0"
...
curl --fail --location --output /tmp/foundry-mcp-bridge-0.2.0.zip \
  https://github.com/Wameuh/Foundry-MC-Server/releases/download/v0.2.0/foundry-mcp-bridge-0.2.0.zip

unzip -l /tmp/foundry-mcp-bridge-0.2.0.zip
```
