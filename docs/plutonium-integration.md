...
Les versions certifiées sont `2.18.1.v14` et `2.18.3.v14`, avec Foundry `14.367` et D&D5e `5.3.3`. Toute autre version désactive Plutonium tout en laissant les outils Foundry natifs disponibles.
